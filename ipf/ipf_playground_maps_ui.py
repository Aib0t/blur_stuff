    ...
    for k in range(0, number_of_parts):
        ...
        for i in range(0, number_of_dots_in_part):
            ...
            if (i % 2) == 0:
                ...
                points_list_2.append((value1, value2))

        map_line_1.points.extend(points_list_1)
        map_line_2.points.extend(points_list_2)

        reversed_list.append(map_line_1)
        reversed_list.append(map_line_2)
...
def main():
    ...
    file = open("./files/ipf/minimap/usa_amboy_game.ipf", "rb").read()
    file_len = len(file)
